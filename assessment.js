...
assessmentButton.onclick = function(){
    ...
    const header = document.createElement('h3'); //タグの作成
    header.innerText = '診断結果'; // タグの中身を'診断結果'に変更
    resultDivided.appendChild(header);// div要素にの小要素としてheaderを追加
